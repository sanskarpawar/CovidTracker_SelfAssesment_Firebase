...
public class IndiaFragment extends Fragment {
    private View IndiaFragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
         IndiaFragmentView = inflater.inflate(R.layout.fragment_india, null);
        bar = (ProgressBar) IndiaFragmentView.findViewById(R.id.progressBar);
        mWaveSwipeRefreshLayout = (WaveSwipeRefreshLayout) IndiaFragmentView.findViewById(R.id.main_swipe);
        // initialize bar
        final MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.refresh);

        mwebView = (WebView) IndiaFragmentView.findViewById(R.id.webview);
